...
int NetWorkHandle::Init(CallBack callBack/* = nullptr*/, const std::string& infoFileName/* = ""*/)
{
#ifndef  _WINDOWS
    SetEvent(callBack);
...
{
    if (!dataBase_->initSqlDataBase(dataBaseInfo_.ip_, dataBaseInfo_.name_, dataBaseInfo_.uid_, dataBaseInfo_.pwd_))
    {
